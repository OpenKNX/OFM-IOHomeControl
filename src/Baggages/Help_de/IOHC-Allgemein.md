...
Die globale Pairing-Übersicht zeigt und liest den aktuellen Zustand aller aktivierten Kanäle über eine ETS-Onlineverbindung aus. Suspendierte Kanäle bleiben sichtbar; deaktivierte Kanäle werden ausgeblendet und beim Aktualisieren übersprungen. Optional kann außerdem die passive Fernbedienungs-Beobachtung aktiviert werden.
