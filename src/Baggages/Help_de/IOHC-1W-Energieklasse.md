...
- **Automatisch** verwendet für VELUX das mit einem netzbetriebenen SML-Rollladen an einer KUX-110-Spannungsversorgung bestätigte Profil mit vier normalen 32-Symbol-Präambeln. Für andere Hersteller bleibt das bisherige Profil erhalten.
...
Für netzbetriebene VELUX-Produkte wie einen SML-Rollladen, der von einem KUX 110 versorgt wird, ist **Automatisch** beziehungsweise **Immer erreichbar** vorgesehen. Der KUX 110 ist dabei die 24-V-Spannungsversorgung, nicht der Funkaktor. Für Solar- oder Batterieempfänger ist **Low Power** vorgesehen; dieses sendet das von KLI-Fernbedienungen beobachtete Profil `1024/32/32/32` mit `LOW_POWER` nur auf der ersten Kopie.
